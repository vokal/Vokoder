...
@interface MigrationProjectTests : XCTestCase

@property (nonatomic) NSURL *persistentStoreURL;

@end

@implementation MigrationProjectTests
...
- (void)testWipeAndRecoverNotification
{
    ...
    [[VOKCoreDataManager sharedInstance] setResource:@"Model"
