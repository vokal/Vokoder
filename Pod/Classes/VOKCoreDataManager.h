...
/**
 ...
 NOTE: This assumes your managed object file is in the same bundle as this class. If it isn't (perhaps because you're using CocoaPods and Swift), use setResource:database:bundle: instead.
...
/**
 ...
 @param database    The filename of the SQLite store in your application. A nil database name will create an in-memory store.
 @param bundle      The bundle where the S
 */
- (void)setResource:(NSString *)resource
           database:(NSString *)database
